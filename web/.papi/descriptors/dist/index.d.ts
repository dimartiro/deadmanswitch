...
import { default as asset_hub, type Asset_hubWhitelistEntry } from "./asset_hub";
export { asset_hub };
export type * from "./asset_hub";
...
export type WhitelistEntry = Stack_templateWhitelistEntry | People_chainWhitelistEntry | Asset_hubWhitelistEntry | BulletinWhitelistEntry;
export type WhitelistEntriesByChain = Partial<{
    "*": WhitelistEntry[];
    stack_template: WhitelistEntry[];
    people_chain: WhitelistEntry[];
    asset_hub: WhitelistEntry[];
