...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<Icibarj4cnrhjh>, false, never>;
        /**
    ...
    Balances: {
         ...
         */
        Holds: StorageDescriptor<[Key: SS58String], Anonymize<I927941htolq52>, false, never>;
        /**
...
type ICalls = {
    ...
    Utility: {
         ...
         * event is deposited.
         */
        batch: TxDescriptor<Anonymize<I2vg55m0708iu8>>;
        /**
         ...
         */
        as_derivative: TxDescriptor<Anonymize<Iarfh6m40k6rnb>>;
        /**
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<I2vg55m0708iu8>>;
        /**
         ...
         * - O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<I4f5q8gguk6s0g>>;
        /**
         * Send a batch of dispatch calls.
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<I2vg55m0708iu8>>;
        /**
         ...
         * The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<I9uevjrtulff4d>>;
        /**
         ...
         * or both.
         */
        if_else: TxDescriptor<Anonymize<I18vl0uu9p6661>>;
        /**
         * Dispatches a function call with a provided origin.
         *
         ...
         * The dispatch origin for this call must be _Root_.
         */
        dispatch_as_fallible: TxDescriptor<Anonymize<I4f5q8gguk6s0g>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<I9789kl2k9d9fa>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<Iceitsfmvm6jcd>>;
        /**
         * Register approval for a dispatch to be made from a deterministic composite account if
         * approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<Iekfsmebt89l18>>;
        /**
         ...
         * - `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<If3g3q9p77cig>>;
        /**
...
type IEvent = {
    System: {
         ...
         * An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I3e85rc2jihmpq>>;
        /**
         * `:code` was updated.
         */
         ...
         */
        RejectedInvalidAuthorizedUpgrade: PlainDescriptor<Anonymize<Icavcef985qtoe>>;
    };
    ParachainSystem: {
        /**
    ...
    Balances: {
         ...
         */
        Held: PlainDescriptor<Anonymize<I6kj39lgrsts4m>>;
        /**
         * Held balance was burned from an account.
         */
        BurnedHeld: PlainDescriptor<Anonymize<I6kj39lgrsts4m>>;
        /**
         * A transfer of `amount` on hold from `source` to `dest` was initiated.
         */
        TransferOnHold: PlainDescriptor<Anonymize<I2266o8v6qnnsm>>;
        /**
         * The `transferred` balance is placed on hold at the `dest` account.
         */
        TransferAndHold: PlainDescriptor<Anonymize<I8qph9tiuqn3el>>;
        /**
         * Some balance was released from hold.
         */
        Released: PlainDescriptor<Anonymize<I6kj39lgrsts4m>>;
        /**
    ...
    Utility: {
         ...
         * well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<Idsenalph6ipe7>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<I570tnuvo31ndd>>;
        /**
         * A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I20fe608pjp7h0>>;
        /**
         ...
         */
        IfElseFallbackCalled: PlainDescriptor<Anonymize<I7oacqrndqtk8s>>;
    };
    Multisig: {
        /**
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<I3dj6hktkmu38f>>;
        /**
    ...
    Proxy: {
         ...
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I20fe608pjp7h0>>;
        /**
...
type IViewFns = {
    Proxy: {
         ...
         */
        check_permissions: RuntimeDescriptor<[call: Anonymize<Ililvlplhron5>, proxy_type: Anonymize<I5ftepkjop3g1u>], boolean>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<Iekrb565d0b69l>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<Ililvlplhron5>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<Ililvlplhron5>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call V2.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I9g869l9vmunib>, call: Anonymize<Ililvlplhron5>, result_xcms_version: number], Anonymize<Idkfq1ik7p2emv>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<Idbonhbnsv7i35>>;
    };
    /**
...
export type Asset_hubDispatchError = Anonymize<Ie0fa6olvqsv29>;
type IAsset = PlainDescriptor<Anonymize<If9iqq7i64mur8>>;
export type Asset_hubExtensions = {};
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type Asset_hub = {
    ...
    asset: IAsset;
    extensions: Asset_hubExtensions;
    getMetadata: () => Promise<Uint8Array>;
    genesis: string | undefined;
};
declare const _allDescriptors: Asset_hub;
export default _allDescriptors;
export type Asset_hubApis = ApisFromDef<IRuntimeCalls>;
export type Asset_hubQueries = QueryFromPalletsDef<PalletsTypedef>;
export type Asset_hubCalls = TxFromPalletsDef<PalletsTypedef>;
export type Asset_hubEvents = EventsFromPalletsDef<PalletsTypedef>;
export type Asset_hubErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type Asset_hubConstants = ConstFromPalletsDef<PalletsTypedef>;
export type Asset_hubViewFns = ViewFnsFromPalletsDef<PalletsTypedef>;
export type Asset_hubCallData = Anonymize<Ililvlplhron5> & {
    value: {
        type: string;
    };
};
type AllInteractions = {
    ...
    tx: {
        ...
        ToWestendXcmRouter: ['report_bridge_status'];
    ...
    events: {
        ...
        ToWestendXcmRouter: ['DeliveryFeeFactorDecreased', 'DeliveryFeeFactorIncreased'];
...
export type Asset_hubWhitelistEntry = PalletKey | `query.${NestedKey<AllInteractions['storage']>}` | `tx.${NestedKey<AllInteractions['tx']>}` | `event.${NestedKey<AllInteractions['events']>}` | `error.${NestedKey<AllInteractions['errors']>}` | `const.${NestedKey<AllInteractions['constants']>}` | `view.${NestedKey<AllInteractions['viewFns']>}` | `api.${NestedKey<AllInteractions['apis']>}`;
type PalletKey = `*.${({
